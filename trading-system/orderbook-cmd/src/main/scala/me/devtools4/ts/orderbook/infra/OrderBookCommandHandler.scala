...
class OrderBookCommandHandler(handler: EventSourcingHandler[Ticker, OrderBookEvent, OrderBookAggregate])
...
object OrderBookCommandHandler {
  def apply(handler: EventSourcingHandler[Ticker, OrderBookEvent, OrderBookAggregate]) =
