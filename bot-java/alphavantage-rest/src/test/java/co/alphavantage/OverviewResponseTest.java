...
public class OverviewResponseTest {
  ...
  private static Consumer<OverviewResponse> check(String output, String exOutput) {
    return x -> {
      assertNotNull(x);
